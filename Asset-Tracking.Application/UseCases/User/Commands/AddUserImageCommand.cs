...
{
    public record AddUserImageCommand(UserImageRequestDto UserImage)
      : IRequest<UserImageResponseDto>;

    public class AddUserImageHandler(IUserImageRepository userImageRepository)
        : IRequestHandler<AddUserImageCommand, UserImageResponseDto>
    {
        public async Task<UserImageResponseDto> Handle(AddUserImageCommand request, CancellationToken cancellationToken)
        {
            ...
            await userImageRepository.AddAsync(entity);
