...
namespace Asset_Tracking.Application.UseCases.Asset.Commands
{
    ...
    public record AddAssetMaintenanceCommand(AssetMaintenanceRequestDto AssetMaintenance) : IRequest<AssetMaintenanceResponseDto>;

    public class AddAssetMaintenanceHandler(IAssetMaintenanceRepository maintenanceRepository) : IRequestHandler<AddAssetMaintenanceCommand, AssetMaintenanceResponseDto>
    {
       public async Task<AssetMaintenanceResponseDto> Handle(AddAssetMaintenanceCommand request, CancellationToken cancellationToken)
        {
            ...
            return new AssetMaintenanceResponseDto()
            {
                ...
                //DateCreated = maintenance.DateCreated,
                UpdatedBy = maintenance.UpdatedBy,
                //DateUpdated = maintenance.DateUpdated
            };
